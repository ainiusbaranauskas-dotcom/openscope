...
export const IDS = {
    ...
    COOP_LOBBY: 'coop-lobby',
    COOP_CREATE_BTN: 'coop-create-btn',
    COOP_JOIN_BTN: 'coop-join-btn',
    COOP_JOIN_CODE: 'coop-join-code',
    COOP_CLOSE_BTN: 'coop-close-btn',
    COOP_LEAVE_BTN: 'coop-leave-btn',
    COOP_ROOM_CODE: 'coop-room-code',
    COOP_CONNECTED_CODE: 'coop-connected-code',
    COOP_LOBBY_MENU: 'coop-lobby-menu',
    COOP_LOBBY_WAITING: 'coop-lobby-waiting',
    COOP_LOBBY_CONNECTED: 'coop-lobby-connected',
    COOP_WAITING_TEXT: 'coop-waiting-text',
    COOP_ERROR: 'coop-error',
    SCORE: 'score',
    SCORE_LOG: 'score-log',
    SIDEBAR: 'sidebar'
};
